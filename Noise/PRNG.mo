...
//
// // // // // // // // // // // // // // // // // // // // // // // // // // // // // //
// Build the actual generator functions
// We have three functions for sample based, sample free and inifite frequency
// random number generation.
protected
  function SampleBasedPSD0 =
    PSD (                    redeclare function PDF=PDF (
                             redeclare function RNG=SampleBasedRNG));
  function SampleFreePSD0 =
    PSD (                    redeclare function PDF=PDF (
                             redeclare function RNG=SampleFreeRNG));
  function InfiniteFreqPSD0 =
    Noise.PSD.PSD_WhiteNoise(redeclare function PDF=PDF (
                             redeclare function RNG=SampleFreeRNG));
